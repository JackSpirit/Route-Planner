...
* Sample Response:
{"path": [{"lat": 39.1512, "lon": -75.5234}, {"lat": 39.1545, "lon": -75.5198}], "distance_km": 4.82, "node_count": 42}
...
* Sample Response:
{"segments": [[[39.1512, -75.5234], [39.1523, -75.5211]], [[39.1523, -75.5211], [39.1541, -75.5195]]]}
...
cd Route-Planner
2. Convert and execute the Go backend package:
go run *.go
